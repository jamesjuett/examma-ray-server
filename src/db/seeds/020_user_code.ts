...
// import { db_setManualGradingRecord, db_createManualGradingRubricItem } from "../db_rubrics";
...
//           await db_createSubmission(sub.question_uuid, question_id, exam_id, sub.student.uniqname, sub.response)
...
//     return db_setManualGradingRecord(group_uuid, rubric_item_id, result?.status);
//   });
