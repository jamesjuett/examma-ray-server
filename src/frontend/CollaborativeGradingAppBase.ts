...
export abstract class CollaborativeGradingAppBase<CGKind extends CollaborativeGraderKind> implements CollaborativeGradingApp<CGKind> {
  ...
  protected readonly skins: ReadonlyMap<string, AssignedQuestionSkin>;

  protected readonly grading_records: GradingRecords<CGKind>;
  protected readonly exam_instances: readonly ExamInstanceInfo[] = [];
  protected readonly submission_records: readonly QuestionSubmissionRecord[];
  protected readonly assigned_questions: readonly AssignedQuestion<GradedResponseKind<CGKind>>[];
