...
exports.ExammaRayClient = void 0;
const js_cookie_1 = __importDefault(__webpack_require__(2733));
const uuid_1 = __webpack_require__(10611);
class ExammaRayClient {
    constructor() {
        this.client_uuid = (0, uuid_1.v4)();
    ...
    onLogin() {
        var _a;
        $(".examma-ray-log-in-button").html(`<i class="bi bi-person-circle"></i> ${(_a = this.currentUser) === null || _a === void 0 ? void 0 : _a.email}`);
...
exports.ExammaRayClient = ExammaRayClient;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.StaffExammaRayGraderApplication = void 0;
const axios_1 = __importDefault(__webpack_require__(72505));
const Application_1 = __webpack_require__(23923);
class StaffExammaRayGraderApplication {
    constructor(client) {
        this.client = client;
    }
    static async create() {
        let app = new StaffExammaRayGraderApplication(await Application_1.ExammaRayClient.create());
    ...
    async reloadExams() {
        ...
        if (this.client.currentUser) {
            try {
                let exams_info = (await (0, axios_1.default)({
                    url: `/api/exams`,
                    method: "GET",
                    data: {},
                    headers: {
...
exports.StaffExammaRayGraderApplication = StaffExammaRayGraderApplication;
async function main() {
    const app = await StaffExammaRayGraderApplication.create();
    $("#create-exam-form").on("submit", async (e) => {
        e.preventDefault();
        let files = $("#exam-spec-file-input")[0].files;
        if (!files || !files[0]) {
            return;
        }
...
/******/ 	var __webpack_exports__ = __webpack_require__(66427);
/******/ 	
