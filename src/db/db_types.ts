...
declare module "knex/types/tables" {
  ...
  interface Tables {
    ...
    collaborative_grading_servers: Knex.CompositeTableType<
      ...
      // Insert Type
      //   All required except grading_server_pk, epoch (defaults to 0), created_at and updated_at (set automatically)
      Omit<DB_Collaborative_Grading_Servers, "grading_server_pk" | "epoch" | "created_at" | "updated_at">,
      // Update Type
    ...
    fitb_drop_rubric_item_evaluators: Knex.CompositeTableType<
      ...
      // Update Type
      //   Only allowed to update name, evaluator, sort_index
      Partial<Pick<DB_FITB_Drop_Rubric_Item_Evaluators, "name" | "spec" | "sort_index">> & Partial<Record<"evaluator_uuid" | "rubric_item_uuid", undefined>>
    >;
